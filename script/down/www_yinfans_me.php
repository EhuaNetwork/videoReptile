...
class www_yinfans_me
{
    ...
    {
        $url = "https://www.yinfans.me/?s=$key";
        ...
        $lists = $xpath->query("/html/body/div[4]/div[2]/ul");//列表xpath
        $video_url = false;
        for ($i = 1; $i <= $lists->length; $i++) {
            $titles = $xpath->query("/html/body/div[4]/div[2]/ul/li[$i]/div[2]/h2/a");//标题xpath
            $hrefs = $xpath->query("/html/body/div[4]/div[2]/ul/li[$i]/div[2]/h2/a");//链接xpath
