...
class www_fantuanhd_com
{
    ...
    {
        $url = "https://www.fantuanhd.com/search/wd/$key.html";
        ...
        $lists = $xpath->query("/html/body/div[1]/div/div/div[2]/ul/li");//列表xpath
        $video_url = false;
        for ($i = 1; $i <= $lists->length; $i++) {
            $titles = $xpath->query("/html/body/div[1]/div/div/div[2]/ul/li[$i]/div/div/h4/a");//标题xpath
            $hrefs = $xpath->query("/html/body/div[1]/div/div/div[2]/ul/li[$i]/div/div/h4/a");//链接xpath
