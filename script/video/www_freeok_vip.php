...
class www_freeok_vip
{
    ...
    {
        $url = "https://www.freeok.vip/vodsearch/-------------.html?wd=$key";
        ...
        $lists = $xpath->query("/html/body/div[1]/div[3]/div/div/div[2]/div/div");//列表xpath
        $video_url = false;
        for ($i = 1; $i <= $lists->length; $i++) {
            $titles = $xpath->query("/html/body/div[1]/div[3]/div/div/div[2]/div/div[$i]/div[2]/div[1]/a/strong");//标题xpath
            $hrefs = $xpath->query("/html/body/div[1]/div[3]/div/div/div[2]/div/div[$i]/a");//链接xpath
