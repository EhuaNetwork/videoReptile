...
class www_libvio_me
{
    ...
    {
        $url = "https://www.libvio.me/search/-------------.html?wd=$key";
        ...
        $lists = $xpath->query("/html/body/div[1]/div[1]/ul/li");//列表xpath
        $video_url = false;
        for ($i = 1; $i <= $lists->length; $i++) {
            $titles = $xpath->query("/html/body/div[1]/div[1]/ul/li[$i]/div/div/h4/a");//标题xpath
            $hrefs = $xpath->query("/html/body/div[1]/div[1]/ul/li[$i]/div/div/h4/a");//链接xpath
