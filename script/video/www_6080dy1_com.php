...
class www_6080dy1_com
{
    ...
    {
        $url = "https://www.6080dy1.com/vodsearch/$key-------------.html";
        ...
        $lists = $xpath->query("/html/body/main/div/div[2]/div/div[1]/div");//列表xpath
        $video_url = false;
        if(self::$debug) dump($url) ;
        for ($i = 1; $i <= $lists->length; $i++) {
            $titles = $xpath->query("/html/body/main/div/div[2]/div/div[1]/div[$i]/div[2]/div[1]/h3/a");//标题xpath
            $hrefs = $xpath->query("/html/body/main/div/div[2]/div/div[1]/div[$i]/div[2]/div[1]/h3/a");//链接xpath
